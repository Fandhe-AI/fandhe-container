<!-- source: https://platform.claude.com/docs/en/api/beta/tunnels/retrieve / last verified: 2026-08-07 -->
...
| `domain` | string | Anthropic-assigned hostname routed through the tunnel. |
